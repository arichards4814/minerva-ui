    ...
    return (
        <div className={classes.root} onClick={props.onClick}>
            ...
            >
                <g>
                    <g>
                        <path className={classes.st0} d="M176.41,66.8v77.59c0,6.32-3.41,11.85-8.49,14.83c-1.32,0.78-2.75,1.39-4.25,1.79
			...
			C168.7,49.59,176.41,57.3,176.41,66.8z"/>
                        <path className={classes.st1} d="M112.84,107.53l-24.29,24.29c-3.5,3.5-9.49,1.02-9.49-3.93V79.3c0-4.95,5.99-7.43,9.49-3.93l24.29,24.29
			C115.02,101.83,115.02,105.35,112.84,107.53z"/>
                    </g>
                    <g>
                        <path className={classes.st2} d="M213.28,147.38c0,10.18-5.7,19.03-14.09,23.53c-2.63,0.88-5.44,1.34-8.36,1.34
			...
			C204.15,123.74,213.28,134.5,213.28,147.38z"/>
                    ...
                    <g>
                        <path className={classes.st0} d="M217.52,145.57c0,11.82-7.68,21.84-18.33,25.35c-2.63,0.88-5.44,1.34-8.36,1.34
			...
			C206.76,120.12,217.52,131.59,217.52,145.57z"/>
                        <path className={classes.st3} d="M194.91,114.25c0,0-0.58,1.86-1.84,4.74c-0.31,0.69-0.66,1.45-1.07,2.26c-2.8,5.7-7.76,13.8-15.59,20.04
			...
			c0.01,0,0.04-0.01,0.05-0.03C185.09,115.41,189.63,114.17,194.91,114.25z"/>
                        <path className={classes.st4} d="M201.98,135.06c0,0,8.43,4.92,6.15,20.01C206.74,148.28,204.62,141.62,201.98,135.06z" />
                    </g>
                </g>
            </svg>
        </div>
